...
cp -r ../Data8Species/prank.alignments.8sp/*.fasta prank/
...
# No trimming
python2.7 GetNewAlignments.py -i ../Results8Species/prank/ -l 100

# Gblocks strict
python2.7 GetNewAlignments.py -i ../Results8Species/prank-strict/ -l 100 -g strict

# Gblocks relaxed
python2.7 GetNewAlignments.py -i ../Results8Species/prank-relaxed/ -l 100 -g relaxed
...
# No trimming
python2.7 RunPhyml.py -i ../Results8Species/prank/ -p ~/Documents/Packages/PhyML-3.1/PhyML-3.1_macOS-MountainLion -t ../Data8Species/InputTree8.txt

# Gblocks strict
python2.7 RunPhyml.py -i ../Results8Species/prank-strict/ -p ~/Documents/Packages/PhyML-3.1/PhyML-3.1_macOS-MountainLion -t ../Data8Species/InputTree8.txt

# Gblocks relaxed
python2.7 RunPhyml.py -i ../Results8Species/prank-relaxed/ -p ~/Documents/Packages/PhyML-3.1/PhyML-3.1_macOS-MountainLion -t ../Data8Species/InputTree8.txt
...
# No trimming
python2.7 SetupPAML.py -i ../Results8Species/prank/ -o ../Results8Species/PAML_prank/ -c ../Data/PAML_Templates/ -s 8 -r 25

# Gblocks strict
python2.7 SetupPAML.py -i ../Results8Species/prank-strict/ -o ../Results8Species/PAML_prank-strict/ -c ../Data/PAML_Templates/ -s 8 -r 25

# Gblocks relaxed
python2.7 SetupPAML.py -i ../Results8Species/prank-relaxed/ -o ../Results8Species/PAML_prank-relaxed/ -c ../Data/PAML_Templates/ -s 8 -r 25
...
# No trimming
python ExtractParameters.py -i ../Results8Species/PAML_prank.results/ -o ../Results8Species/PAML_prank_Results/
...
# Gblocks strict
python ExtractParameters.py -i ../Results8Species/PAML_prank-strict.results/ -o ../Results8Species/PAML_prank-strict_Results/

# Gblocks relaxed
python ExtractParameters.py -i ../Results8Species/PAML_prank-relaxed.results/ -o ../Results8Species/PAML_prank-relaxed_Results/
...
# No trimming
python ExtractBest.py -i ../Results8Species/PAML_prank_Results/

# Gblocks strict
python ExtractBest.py -i ../Results8Species/PAML_prank-strict_Results/

# Gblocks relaxed
python ExtractBest.py -i ../Results8Species/PAML_prank-relaxed_Results/



cp ../Results8Species/prank/Alignments.csv ../Results8Species/PAML_prank_Results/Alignments.csv
cp ../Results8Species/prank-strict/Alignments.csv ../Results8Species/PAML_prank-strict_Results/Alignments.csv
cp ../Results8Species/prank-relaxed/Alignments.csv ../Results8Species/PAML_prank-relaxed_Results/Alignments.csv

cd ../PAML_prank_Results
sed -i .bak s/'\.fasta'//g Alignments.csv
cd ../PAML_prank-relaxed_Results
sed -i .bak s/'\.fasta'//g Alignments.csv
cd ../PAML_prank-strict_Results
sed -i .bak s/'\.fasta'//g Alignments.csv
